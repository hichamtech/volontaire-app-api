 ...
 */
final class Version20200606160423 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD post_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reclamation ADD CONSTRAINT FK_CE6064044B89032C FOREIGN KEY (post_id) REFERENCES post (id)');
        $this->addSql('CREATE INDEX IDX_CE6064044B89032C ON reclamation (post_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reclamation DROP FOREIGN KEY FK_CE6064044B89032C');
        $this->addSql('DROP INDEX IDX_CE6064044B89032C ON reclamation');
        $this->addSql('ALTER TABLE reclamation DROP post_id, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
