 ...
 */
final class Version20200512124659 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD image_id INT DEFAULT NULL, CHANGE ville_id ville_id INT DEFAULT NULL, CHANGE last_connection last_connection DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP image_id, CHANGE ville_id ville_id INT DEFAULT NULL, CHANGE last_connection last_connection DATETIME DEFAULT \'NULL\'');
